...
cv::Vec3f Object::getDims() {
    return this->dims;
}

std::string Object::getProperties() {
    return "name:" + this->name + "~"
            + this->properties + "~" + this->add_properties;
}

std::string Object::getAddProperties() {
    return this->add_properties;
}

void Object::updateProperties(std::string properties) {
    this->add_properties = properties;
}

void Object::updateCoords(cv::Point coords) {
    this->coords = coords;
}
...
std::string Object::getStringType() {
    std::string s;
...
std::vector<cv::Point2i> Object::getVertexCoords() {
